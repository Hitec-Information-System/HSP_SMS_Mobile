...
abstract class $UserDTOCopyWith<$Res> {
  ...
  $Res call(
      ...
      @JsonKey(name: "USER_NM") String name,
...
class _$_UserDTO extends _UserDTO {
  const _$_UserDTO(
      ...
      @JsonKey(name: "USER_NM") required this.name,
  ...
  @override
  String toString() {
    return 'UserDTO(id: $id, name: $name, compCd: $compCd)';
  }
...
abstract class _UserDTO extends UserDTO {
  const factory _UserDTO(
      {@JsonKey(name: "USER_ID") required String id,
      @JsonKey(name: "USER_NM") required String name,
      @JsonKey(name: "COMP_CD") required String compCd}) = _$_UserDTO;
