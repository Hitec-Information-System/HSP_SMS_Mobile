...
class _$UserTearOff {
  ...
  _User call(
      {required String id, required String name, required String compCd}) {
    return _User(
      id: id,
      name: name,
      compCd: compCd,
...
abstract class $UserCopyWith<$Res> {
  ...
  $Res call({String id, String name, String compCd});
}
...
class _$_User extends _User {
  const _$_User({required this.id, required this.name, required this.compCd})
      : super._();
  ...
  @override
  String toString() {
    return 'User(id: $id, name: $name, compCd: $compCd)';
  }
...
abstract class _User extends User {
  const factory _User(
      ...
      required String compCd}) = _$_User;
