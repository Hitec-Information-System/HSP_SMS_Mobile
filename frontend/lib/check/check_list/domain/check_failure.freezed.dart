...
/// @nodoc
class _$CheckFailureTearOff {
  const _$CheckFailureTearOff();
...
/// @nodoc
const $CheckFailure = _$CheckFailureTearOff();

/// @nodoc
mixin _$CheckFailure {
  ...
  @JsonKey(ignore: true)
  $CheckFailureCopyWith<CheckFailure> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $CheckFailureCopyWith<$Res> {
  factory $CheckFailureCopyWith(
          CheckFailure value, $Res Function(CheckFailure) then) =
      _$CheckFailureCopyWithImpl<$Res>;
  $Res call({int? errorCode});
}

/// @nodoc
class _$CheckFailureCopyWithImpl<$Res> implements $CheckFailureCopyWith<$Res> {
  _$CheckFailureCopyWithImpl(this._value, this._then);

  final CheckFailure _value;
  // ignore: unused_field
  final $Res Function(CheckFailure) _then;
...
/// @nodoc
abstract class _$ApiCopyWith<$Res> implements $CheckFailureCopyWith<$Res> {
...
/// @nodoc
class __$ApiCopyWithImpl<$Res> extends _$CheckFailureCopyWithImpl<$Res>
...
class _$_Api extends _Api {
  ...
  @override
  String toString() {
    return 'CheckFailure.api(errorCode: $errorCode)';
  }
...
abstract class _Api extends CheckFailure {
